...
/*
 ...
 var src = audioCtx.createMediaElementSource(window.document.getElementById("player"));
 ...
 var z =analyser.getByteTimeDomainData(dataArray);
 var canvas = window.document.getElementById('viz');
 var pencil = canvas.getContext("2d");
 pencil.fillStyle = "rgb(10,10,10)";
 ...
 pencil.fillRect(i * barWidth, offset, barWidth, height);
 }
